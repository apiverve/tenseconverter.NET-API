...
namespace APIVerve
{
    public class TenseConverterAPIClient
    {
        ...
        public TenseConverterAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public TenseConverterAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(tenseconverterQueryOptions options)
        {
            try
            {
                if (_isDebug)
